# -*- coding: utf-8 -*-
#
# QnodeCoin documentation build configuration file, created by
...
project = u'QnodeCoin Documentation'
copyright = u'2020, The Quatumnode Group'
author = u'Bryte Morio'
...
language = None
# We are doing content transnlation via gettext catalogs.
locale_dirs = ['locale/']
...
# documentation.
html_theme_options = {'canonical_url': 'doc.qngnode.cc',
